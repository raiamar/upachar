                ...
                <div class="form-default bg-white p-4">
                        ...
                        <div class="">
                            <table class="table-cart border-bottom">
                                ...
                                <tbody>
                                    ...
                                    // $product_name_with_choice .= ' - '.\App\Color::where('code',
                                    $cartItem['color'])->first()->name;
                                    // }
                    ...
                    <div class="row align-items-center pt-4">
                        ...
                        <div class="col-md-6 text-right">
                            @if(Auth::check())
                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1"
                                style="color: black">{{__('Continue to Shipping')}}</a>
                            @else
                            <button class="btn btn-styled btn-base-1" onclick="showCheckoutModal()">{{__('Continue to
                                Shipping')}}</button>
                            @endif
                        </div>
                    </div>
...
<section id="cart-wrapper" class="py-3">
    <div class="container">
        ...
        <div class="row py-xl-5 py-md-3 py-0">
            <div class="col-xl-3 col-lg-3 col-md-3 col-3 mb-xl-0 mb-lg-0 mb-0">
                                ...
                                <div class="table-responsive-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart-product-name-info">
                                                    <h4 class="cart-product-description"><a href="">{{
                                                            $product_name_with_choice }}</a></h4>
                                                    <div class="row">
                                                        <div class="col-4">
                                                ...
                                                <td class="romove-item"><a
                                                        onclick="removeFromCartView(event, {{ $key }})" title="cancel"
                                    ...
                                    <div class="d-flex justify-content-around align-items-center w-100 my-3 flex-wrap">
                                        ...
                                        <div class="">
                                            <form
                                                class="coupon-field d-flex flex-wrap align-items-center justify-content-center"
                                                action="{{ route('checkout.apply_coupon_code') }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="text" placeholder="Apply Coupon Code" class="mr-2"
                                                    name="code" required>
            ...
            <div class="col-lg-6 col-md-4 col-12" style="margin:15px 0 0 28%; position: -webkit-sticky;
            position: sticky;
            top: 0;">
            {{-- <div class="col-lg-4 col-md-12 col-12 mb-xl-0 mb-lg-0 mb-3"> --}}
                <div class="cart-box d-flex flex-wrap justify-content-between align-items-center text-center">
                    ...
                    <div class="col-12 my-3">
                        @if(Auth::check())
                        <button type="button" class="effect"><a href="{{ route('checkout.shipping_info') }}"
                                class="text-white">Proceed Checkout</a></button>
                        @else
                        <button class="btn btn-styled btn-base-1" onclick="showCheckoutModal()">{{__('Continue to
                            Shipping')}}</button>
                        @endif
        ...
        @else
        <div class="row py-xl-5 py-md-3 py-0">
            <div class="col-xl-3 col-lg-3 col-md-3 col-3 mb-xl-0 mb-lg-0 mb-3">
                @if(Auth::user()->user_type == 'seller')
                    @include('frontend.inc.seller_side_nav')
                @elseif(Auth::user()->user_type == 'customer')
                    @include('frontend.inc.customer_side_nav')
            ...
            <div class="col-lg-8 col-md-9 col-9">
                <h6 style="margin: 30px 0 30px 0; text-align: center">{{__('Your cart is empty')}}</h6>
            </div> 
        </div>   
        @endif
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">{{__('Guest
                        Checkout')}}</a>
                </div>
                @endif
            </div>
