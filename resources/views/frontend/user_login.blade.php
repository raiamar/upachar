    ...
    <section id="login-register-page-wrapper">
        <section id="top-ads-wrapper">
            <div class="alert alert-dismissible fade show position-relative border-0 m-0 p-0" role="alert">
                ...
                <button type="button" class="close position-absolute text-white" data-dismiss="alert"
                    aria-label="Close">
            ...
            <nav class="navbar header-sticky justify-content-around">
                ...
                <div class="navbar-menus d-xl-block d-lg-block d-none" id="navbarmain">
                    <ul class="navbar-nav py-4 py-md-0 d-flex flex-row flex-wrap" role="menu">
                                ...
                                <div class="row p-4">
                                        ...
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link head font-weight-bold"
                                                    href="product-listing.html">Heading 27</a>
                                            </li>
                                    ...
                                    <div class="col-md-3">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link head font-weight-bold"
                                                    href="product-listing.html">Heading 29</a>
                                            </li>
                                            <li class="nav-item p-0">
                                                <a class="nav-link" href="product-listing.html">Item 1</a>
                                            </li>
                        ...
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                            <a class="nav-link toggle" data-toggle="dropdown" href="product-listing.html" role="button"
                        ...
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
                                href="product-listing.html" role="button" aria-haspopup="true" aria-expanded="false">
                                Categories
                                <span class="ml-1">
                                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                                </span>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center position-relative">
                    <div class="col-xl-5 col-lg-5 col-md-7 col-12 login-wrap">
                        <form class="px-xl-5 px-lg-5 px-md-4 px-3 pt-5 pb-2">
                            <div class="FormLeft text-center">
                                ...
                                <button class="effect anchor-btn">
                                    Login
                                </button>
                    ...
                    <ul class="search-list-wrapper w-100">
                        <li class="mb-2 p-1">
                            <a href="product-detail.html">
                                <div class="row">
                                    <div class="col-2">
                                        <div class="image"> <img src="{{asset('frontend/assets/images/product-images/1.jpg')}}"
                ...
                <div class="modal-body d-flex align-items-center justify-content-around h-100 w-100 p-0">
                    <div class="dashboard-list2 px-2 py-0">
                        <div class="d-user-avater text-center mb-4">
                            <img src="{{asset('frontend/assets/images/product-images/1.jpg')}}" class="img-fluid avater"
                                alt="profile-image">
