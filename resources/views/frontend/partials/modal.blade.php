            ...
            <ul class="search-list-wrapper w-100">
                <li class="mb-2 p-1">
                    <a href="">
                        <div class="row">
                            <div class="col-2">
                                <div class="image"> <img src="frontend/assets/images/product-images/1.jpg" alt="search-list-image" class="img-fluid">
                                </div>
                            </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer flex-column">
            ...
            <div class="d-flex justify-content-around align-items-center w-100">
                <button type="button" class="effect anchor-btn m-auto">View Cart</button>
                <button type="button" class="effect anchor-btn m-auto">Proceed Checkout</button>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="filter-content2 mt-3">
                                    <div class="card-body">
                                        <div class="slider slider-horizontal" id="range-slider">
                                            ...
                                            <input type="range" class="slider d-block w-100" value="5" data-slider-min="1" data-slider-max="1000"
                                                data-slider-step="1" data-slider-value="5" data-slider-orientation="horizontal" data-slider-enabled="true"
                                                data-slider-selection="after" data-slider-tooltip="always" data-slider-range="true" />
                                        </div>
                                        <!-- card-body.// -->
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="card-wrapper mb-2">
                            <div class="card-group-item">
                                ...
                                <div class="colors_block p-3">
                                    <label class="color_single" <span=""> Small
                                        <input type="checkbox" checked="checked">
                                        <span class="checkmark"></span>
                                        </label>
                                    <label class="color_single">
                        ...
                        <div class="container d-block">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link head font-weight-bold" href="product-listing.html">Heading 39</a>
                                        </li>
                                        <li class="nav-item p-0">
                                            <a class="nav-link" href="product-listing.html">Item 1</a>
                                        </li>
                                ...
                                <div class="col-md-12">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link head font-weight-bold" href="product-listing.html">Heading 4</a>
                                        </li>
                                        <li class="nav-item p-0">
                                            <a class="nav-link" href="product-listing.html">Item 1</a>
                                        </li>
                                ...
                                <div class="col-md-12">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link head font-weight-bold" href="product-listing.html">Heading 1</a>
                                        </li>
                                        <li class="nav-item p-0">
                                            <a class="nav-link" href="product-listing.html">Item 1</a>
                                        </li>
                                ...
                                <div class="col-md-12">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link head font-weight-bold" href="product-listing.html">Heading 2</a>
                                        </li>
                                        <li class="nav-item p-0">
                                            <a class="nav-link" href="product-listing.html">Item 1</a>
                                        </li>
                                ...
                                <div class="col-md-12">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link head font-weight-bold" href="product-listing.html">Heading 3</a>
                                        </li>
                                        <li class="nav-item p-0">
                                            <a class="nav-link" href="product-listing.html">Item 1</a>
                                        </li>
        ...
        <div class="modal-body d-flex align-items-center justify-content-around h-100 w-100 p-0">
            <div class="dashboard-list2 px-2 py-0">
                <div class="d-user-avater text-center mb-4">
                    ...
                    <a href=""> <span class="mr-1"><i class="fa fa-pencil" aria-hidden="true"></i></span> Upload
                        Image
                    </a>
                </div>
                <ul class="sidebar">
