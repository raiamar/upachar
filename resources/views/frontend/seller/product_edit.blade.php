                    ...
                    <div class="main-content">
                        ...
                        <form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                                                        ...
                                                        @foreach (json_decode($product->photos) as $key => $photo)
                                                            <div class="col-md-3">
                                                                <div class="img-upload-preview">
                                                                    <img loading="lazy"  src="{{ asset($photo) }}" alt="main image" class="img-responsive" height="400px" width="500px">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                @if ($product->thumbnail_img != null)
                                                    <div class="col-md-3">
                                                        <div class="img-upload-preview">
                                                            <img loading="lazy"  src="{{ asset($product->thumbnail_img) }}" alt="thumbnail image" class="img-responsive" height="400px" width="500px">
                            ...
                            <div class="form-box mt-4 text-right">
                                <button type="submit" class="effect">{{ __('Update This Product') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
